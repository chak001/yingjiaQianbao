...
public class HistoryActivity extends BaseListActivity  implements View.OnClickListener,CommonView{
    ...
    public void initTitle() {
        ...
        viewHolder.titleBg.setImageResource(0);
        viewHolder.titleBg.setBackgroundResource(R.color.white);
        viewHolder.titlename.setText(R.string.history);
    ...
    public void InitOthers() {
        ...
        commonPresenter.getCommonData(PINGTAITYPE,queryBean, DC.liulanjilu,true);
    }
    ...
    public void asyLoadingMoreData() {
        commonPresenter.getCommonData(PINGTAIMORETYPE,queryBean, DC.liulanjilu,true);
    }
