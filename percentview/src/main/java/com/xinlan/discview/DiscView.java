...
public class DiscView extends FrameLayout {
    ...
    private void readAttributeAndSet(Context context, AttributeSet attrs) {
        ...
        contentValueText.setTextColor(mCircleView.mRadiusColor);

        Drawable drawable1=mContext.getResources().getDrawable(R.mipmap.percent);
        drawable1.setBounds(0,0, util.dip2px(mContext,11),util.dip2px(mContext,12));//第一0是距左边距离，第二0是距上边距离，40分别是长宽
        contentValueText.setCompoundDrawables(null,null,drawable1,null);
    }
    ...
    public void setValue(int value, int duration) {
        ...
        animator.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() {
            ...
            public void onAnimationUpdate(ValueAnimator animation) {
                ...
                mCircleView.setValue(changeUnit(value));
    ...
    public int changeUnit(int percent){
        float rate= percent*1.00f/100;
        return (int) (rate*360);
    }
}//end class
